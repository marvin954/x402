...
<div class="endpoints">
  ...
  <table>
    ...
    <tr><td><span class="method post">POST</span></td><td class="highlight">/api/workflows/lead-extraction</td><td>X-Payment (v1) / PAYMENT-SIGNATURE (v2)</td><td>Lead extraction — extract qualified leads from text/URLs with contact info, pain points, confidence scores ($1.00)</td></tr>
